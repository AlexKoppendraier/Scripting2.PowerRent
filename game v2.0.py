...
intro, Introduction, gameExit,playing, players, throwdice, Options, Questions = True, False, False, False, False, 0, False, False
...
def questionview():
    ...
    while Questions:
        ...
        TextRect.center = ((display_width / 2), (display_height / 4))
        gameDisplay.blit(TextSurf, TextRect)
        button(str(questionview.list[2]), 115, 250, 275, 50, tint_green, red)
        button(str(questionview.list[3]), 410, 250, 275, 50, tint_green, red)
        button(str(questionview.list[4]), 115, 325, 275, 50, tint_green, red)
        button(str(questionview.list[5]), 410, 325, 275, 50, tint_green, red)
        clock.tick(15)  #refresh rate van 15
        pygame.display.flip()
def question():
    check = 0
...
def game_options():  #opties menu
    ...
    while Options:
        ...
        button("Back", 50, 500, 700, 50, tint_red, red, callquestion,  questionview)
